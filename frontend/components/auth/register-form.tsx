...
export function RegisterForm() {
  const { loginWithGoogle, register: signup, login } = useAuth();
  ...
  const handleGoogleLogin = async (e: React.FormEvent) => {
    ...
    if (!customGoogleEmail || !customGoogleName) {
      setError("Please fill in both email and name for Google Sign-Up.");
      return;
    }
    ...
    try {
      ...
      console.error(err);
      setError("Failed to register with Google account. Please try again.");
    } finally {
