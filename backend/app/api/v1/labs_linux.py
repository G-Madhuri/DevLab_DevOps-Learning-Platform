...
async def websocket_terminal(websocket: WebSocket, session_id: str):
    ...
    sim_shell = None
    if container_id and (container_id.startswith("simulated-") or container_id.startswith("git-") or container_id.startswith("actions-") or container_id.startswith("cicd-") or container_id.startswith("jenkins-") or container_id.startswith("terraform-") or container_id.startswith("ansible-") or container_id.startswith("aws-") or container_id.startswith("azure-") or container_id.startswith("monitoring-") or container_id.startswith("observability-")):
